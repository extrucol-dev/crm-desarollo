CREATE OR REPLACE PACKAGE BODY CRM_ACTIVIDADES_API AS
  ...
  BEGIN
    INSERT INTO crm_actividades
      (tipo, descripcion, virtual, fecha_actividad,
       oportunidad_id, ejecutivo_id)
      VALUES (p_x01, p_x02, p_x03,
              TO_DATE(p_x04,'YYYY-MM-DD'), p_x05, 3)
  ...
  PROCEDURE ACTIVIDADES_GET(p_result OUT SYS_REFCURSOR,
                             p_x01 IN NUMBER) IS
  BEGIN
    OPEN p_result FOR
      SELECT a.id, a.tipo, a.descripcion, a.resultado, a.virtual,
             ...
             a.latitud, a.longitud, a.activo,
             a.fecha_creacion, a.fecha_update
