...
const NAV_BY_ROL = {
  ...
  COORDINADOR: [
    ...
    { to: '/coordinador/actividades',      icon: 'clipboard', label: 'Actividades' },
    ...
    { to: '/coordinador/variables',       icon: 'settings',  label: 'Variables sistema' },
  ],
  ADMIN: [
    { to: '/dashboard',      icon: 'home',    label: 'Dashboard'  },
    { to: '/usuarios',       icon: 'user',    label: 'Usuarios'   },
    { to: '/admin/catalogos',icon: 'archive', label: 'Catálogos'  },
